package com.hr.navigator.business.ui.login
...
import com.hr.navigator.business.databinding.ActivityMainBinding
...
import com.hr.navigator.business.utils.HandlerTimer
...
class LoginActivity : BaseActivity() {
    ...
    private fun isCheckAlreadyData() {
        progressDialogs.showProgressDialog()
        val mPhoneNumber = "+91$phoneNumber"
        val postRef = FirebaseDatabase.getInstance().reference.child("CompanyList")
